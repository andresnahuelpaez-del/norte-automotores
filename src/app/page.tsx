  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white -mt-[108px] pt-[108px]">
        ...
        <div className="relative lg:hidden h-[88dvh] overflow-hidden flex flex-col">
          {/* Slider de fondo — imágenes verticales */}
          <div className="absolute inset-0">
            <HeroSlider images={["/hero-mobile-1.jpg", "/hero-mobile-2.jpg", "/hero-mobile-3.jpg"]} dots={false} objectPosition="center" />
          </div>
          {/* Degradado: oscuro arriba (texto) y abajo (stats), abierto al medio */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A1524]/92 via-[#0A1524]/25 to-[#0A1524]/88 pointer-events-none" />

          <div className="relative z-10 px-5 pt-[120px] pb-9 flex-1 flex flex-col justify-between">
            {/* Texto */}
            <div>
              ...
              <div className="glint">
                <h1 className="font-display font-black text-[3.5rem] text-white uppercase tracking-tight leading-[0.85] mb-5">
              ...
              <p className="text-white/75 text-[13px] leading-relaxed font-mono max-w-xs">
            ...
            {/* Stats */}
            <div className="flex pt-6 border-t border-white/15">
              {[
